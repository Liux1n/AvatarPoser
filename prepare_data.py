...
for dataroot_subset in ["MPI_HDM05", "BioMotionLab_NTroje", "CMU"]:
    ...
    for phase in ["train","test"]:
        ...
        #    else:
            ...
            # print(bdata_poses.shape) # (3154, 156)
            bdata_trans = bdata["trans"][::stride,...]
            # print(bdata_trans.shape) # (3154, 3)
        ...
        #            self.rotation_local_full_gt_list.append(torch.Tensor(bdata['poses'][:, :66]))
            ...
            # print(rotation_local_matrot.shape) # torch.Size([3154, 52, 9])
            ...
            # print(head_global_trans_list.shape) # torch.Size([3153, 4, 4])
